...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Peaks_annot_encode2.pdf", width=8, height=3)
...
If peak was called in a cell type, does it overlap H3K27ac of that cell type?
For peaks that were called in multiple cell types, they may overlap H3K27ac of only one cell type. (ie. peak called in microglia and astrocytes but only overlaps microglia H3K27ac)
```{r,eval=F}
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/CTpeaks_olapk27_barPlot2_filtered0.02_XY.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Top_downDEG_GObp.pdf", width=13, height=5)
ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Top_upDEG_GObp.pdf", width=10, height=5)
ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/AD_DEGs_MAST_heatmap_foldCs.pdf", width=6, height=8)
...
genes<-read.csv("~/Documents/scMultiomics_AD/testing.csv", col.names=1)
genes$X1<-gsub(" ","", genes$X1)
tmp<-strsplit(genes$X1, ",")
tmp<-unlist(tmp)
write.csv(tmp, "~/Documents/scMultiomics_AD/Luciferase_linked_genes.csv")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/AD_DEGs_MAST_heatmap_foldCs_wTestingLabel_otherColorScale2.pdf", width=6, height=8)
rowAnnotation(gene=anno_mark(at=lab, labels=noDup[lab,]$gene, side="left", labels_gp=gpar(fontsize=10)))+ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Shared_degs_heatmap_up.pdf", width=8,height=4)
ht+ht2
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Mathys_morabito_our_degs.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Mathys_morabito_Our_degs_venn.pdf", width=4, height=4)
v=venn(dat)
plot(v)
dev.off()
```
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Ast_subclusters.pdf")
...
library(stringr)
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Ast_subcluster_GObp.pdf", width=8, height=4)
   ht 
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Ast_stat_prop_bar_wTotalCells_log10.pdf", width=5,height=6)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Ast_top10DEG_heatmap.pdf", width=4, height=6)
ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/topick_Astrocytes_subclusters.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Inh_subclusters.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/IN_marker_vlnplot_2.pdf", width=15,height=20)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Azimuth_In_layers2.pdf", width=7, height=5)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/In_marker_expression_plot.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/In_marker_featPlot.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/IN_marker_dotplot.pdf", width=6, height=8)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/In_Subtype_heatmap.pdf", width=5,height=6)
ht
dev.off()
...
library(stringr)
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Inh_subcluster_GObp.pdf", width=8, height=4)
   ht 
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/In_CT_stat_prop_tt.pdf", width=10,height=5)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Exc_subclusters.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Azimuth_Ex_layers.pdf", width=8, height=5)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Azimuth_Ex_layers_label.pdf", width=5, height=5)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Neuron_Subtype_heatmap_Ex.pdf", width=4,height=8)
ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Ex_marker_dotplot.pdf", width=10, height=9)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/EX_marker_upset_annotation.pdf",width=3, height=10)
...
library(stringr)
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Exc_subcluster_GObp.pdf", width=9, height=3.5)
   ht 
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Ex_CT_stat_prop_tt.pdf", width=10,height=5)
ggboxplot(df, y="Freq",x="Var2", fill="Status", alpha=0.8)+stat_pvalue_manual(stat.test, label="p")+xlab("")+scale_fill_manual(values=c("red","blue"))
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Olig_subclusters.pdf")
...
library(stringr)
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Olig_subcluster_GObp.pdf", width=8, height=6)
   ht 
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Olig_GO_bp_cluster2.pdf", width=12, height=6)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Olig_CT_stat_prop_tt.pdf", width=10,height=5)
ggboxplot(df, y="Freq",x="Var2", fill="Status", alpha=0.8)+stat_pvalue_manual(stat.test, label="p")+xlab("")+scale_fill_manual(values=c("red","blue"))
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Olig_stat_prop_bar_wTotalCells_log10.pdf", width=5,height=6)
p1=ggplot(df, aes(x=Freq*100,y=Var2,fill=Var1))+geom_bar(stat="identity")+theme_classic()+scale_fill_manual(values=c(AD,Ctrl))+xlab("%")+ylab("")+theme(legend.title=element_text(size=0), legend.position="none")+ggtitle("Donor")+scale_y_discrete(limits=rev(levels(df$Var2)))
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Olig_top10DEG_heatmap.pdf", width=4, height=6)
ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Olig_top10DEG_heatmap_transpose.pdf", width=4, height=6)
ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Mic_subclusters.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Microglia_Degs_overlap_heatmap_dropCluster2.pdf", width=5,height=8)
ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Microglia_Degs_overlap_heatmap_dropCluster2.pdf", width=7,height=3)
ht2
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Microglia_Degs_overlap_heatmap_0v1v2.pdf", width=4,height=3)
ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Mic_GO_bp_cluster2.pdf", width=12, height=6)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Mic_CT_stat_prop_tt.pdf", width=6,height=5)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/All_subclusters_plot_wLegend.pdf", width=9, height=10)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/scREAD_heatmap_byID.pdf", width=5,height=8)
...
library(cowplot)
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/marker_coverage_plot.pdf", width=12, height=7)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Allsubs_stat_prop_bar.pdf", width=5,height=6)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Allsubs_stat_prop_bar_wTotalCells_log10.pdf", width=5,height=6)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/CT_id_corMat_heatmap.pdf")
ht
dev.off()
...
peak_set<-write.table(rownames(Peak2),"~/scMultiomics_AD/CT_filtered_peaks.bed")
```
...
part1<-import("/cluster/home/aanderson/scMultiomics_AD/reanalyze_filterPeaks_AD/outs/analysis/feature_linkage/feature_linkage.bedpe", format="bedpe")
...
part1<-import("/cluster/home/aanderson/scMultiomics_AD/reanalyze_filterPeaks_Ctrl/outs/analysis/feature_linkage/feature_linkage.bedpe", format="bedpe")
...
write.table(tab2, "~/scMultiomics_AD/Melt_ct_link_table_filtered_wXY.txt", sep="\t", quote=F)
...
c2<-GRanges(t)
saveRDS(c2, "~/scMultiomics_AD/AD_Ctrl_links_UMI200_annot.rds")

```

## Filter by UMI
Only genes with at least 200 UMIs were retained in the links
```{r,eval=F}
...
saveRDS(s2, "~/scMultiomics_AD/AD_Ctrl_links_UMI200.rds")
```
...
saveRDS(links_200.anno, "~/scMultiomics_AD/XY_Filtered_AD_Ctrl_links_UMI200_annot.rds")
...
pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/TBR1_trio_",index ,"_linkPlot.pdf"), width=6, height=7)
p
dev.off()
...
write.csv(redo_format,"/cluster/home/aanderson/scMultiomics_AD/celltype_specific_links_anno_hg38.csv")
...
redo_format$Microglia.k27<-grepl("Microglia",redo_format$k27)
redo_format$Oligodendrocytes.k27<-grepl("Oligodendrocytes",redo_format$k27)
write.csv(redo_format,"/cluster/home/aanderson/scMultiomics_AD/all_links_anno_hg38.csv")
...
saveRDS(c10,"~/scMultiomics_AD/GRN/c10.rds")
saveRDS(a10,"~/scMultiomics_AD/GRN/a10.rds")
...
avgExp<-as.data.frame(AverageExpression(ad, group.by="seurat_clusters", assay="RNA"))
avgAcc<-as.data.frame(AverageExpression(ad, group.by="seurat_clusters",assay="CTpeaks"))
write.csv(avgExp, "~/scMultiomics_AD/GRN/Ctrl_MetaCell_Expression.csv")
write.csv(avgAcc, "~/scMultiomics_AD/GRN/Ctrl_MetaCell_Accessibility.csv")
...
```{r,eval=F}
files=as.list(readLines("/cluster/home/aanderson/scMultiomics_AD/GRN/AD_list.csv"))
files[[11]]<-files[[1]]
files[[1]]<-NULL
AD_list=lapply(files,function(x){
  FT=read.csv(x)})

files=as.list(readLines("/cluster/home/aanderson/scMultiomics_AD/GRN/Ctrl_list.csv"))
files[[11]]<-files[[1]]
files[[1]]<-NULL
...
a10<-readRDS("~/scMultiomics_AD/GRN/a10.rds")
c10<-readRDS("~/scMultiomics_AD/GRN/c10.rds")
all<-readRDS("~/scMultiomics_AD/GRN/ALL_wMotifScore_MaxAcc.rds" )
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Trio_peak_annot_encode.pdf", width=8, height=3)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Triangle_correlations.pdf", width=10, height=10)
...
pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/Triangle_correlations_",CT,".pdf"), width=10, height=10)
ht1
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Triangle_correlations_Neuron_ExIn.pdf", width=5, height=10)
ht1
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/MEF2C_trios_heatmap.pdf", width=6, height=7)
ht
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/MEF2C_boxplot.pdf", width=6, height=4)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/MEF2C_target_GOenrichment_byCT.pdf")
...
region<-GRanges("chr4:90030247-90031491")
start(region)<-start(region)-1000
end(region)<-end(region)+1000
ChIP_track1<-BigwigTrack(region,"/cluster/home/jloupe/Outputs_AD-supp/Jul2021_ChIPseq/MEF2C_AD-B5_Output/signal/pooled-rep/basename_prefix.pooled_x_basename_prefix.pooled.pval.signal.bigwig",smooth = 300)+ylab("AD")+theme(legend.position="none")+scale_fill_manual(values="red")+ylim(0,10)
ChIP_track2<-BigwigTrack(region,"/cluster/home/jloupe/Outputs_AD-supp/Jul2021_ChIPseq/MEF2C_AD-CTL_Output/signal/pooled-rep/basename_prefix.pooled_x_basename_prefix.pooled.pval.signal.bigwig",smooth = 300)+ylab("Ctrl")+theme(legend.position="none")+ylim(0,10)+scale_fill_manual(values="blue")
ChIP_track3<-BigwigTrack(region,"/cluster/home/jloupe/Outputs_other/Jan2021_ChIPseq/MEF2C_OL-NEUN_PT2_test/signal/pooled-rep/basename_prefix.pooled_x_basename_prefix.pooled.pval.signal.bigwig",smooth = 300)+ylab("NEUN")+theme(legend.position="none")+ylim(0,10)+scale_fill_manual(values="grey54")


p<-CombineTracks(plotlist=list(ChIP_track1,ChIP_track2,ChIP_track3), heights=c(2,2,2))

pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/MEF2C_ADCtrl_NEUN.pdf"), width=6, height=7)
p
dev.off()
...
#motifs<-readRDS("~/scMultiomics_AD/motif/motifs_object.rds")
...
pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/MEF2C_trio_",gene ,"_linkPlot.pdf"), width=6, height=7)
p
dev.off()
...
pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/ZEB1_trio_GABRA5_linkPlot_zoomed.pdf"), width=6, height=7)
p
dev.off()

pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/ZEB1_trio_GABRA5_linkPlot_justchip.pdf"), width=6, height=3)
ChIP_track
dev.off()
...
pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/ZEB1_trio_GABRA5_linkPlot_byCT.pdf"), width=6, height=7)
p
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/ZEB1_GABRA5_neuronSubtypes.pdf", width=8, height=5)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Acc_GEX_link_filtered.pdf")
ht1+ht2
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/AD_linksPerGene_filt.pdf", height=5,width=7)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/AD_linksPerGene_Perm80.pdf", height=5,width=7)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/AD_FL_upset_filt_XY.pdf", width=8, height=5)
u
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Ctrl_FL_upset_filt_XY.pdf", width=8, height=5)
u2
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Link_annot_byCT_filtered_encode2.pdf", width=8, height=3)
ggplot(df, aes(x=value, y=variable, fill=annot))+geom_bar(stat="identity")+xlab("Proportion of Linked peaks")+ylab("Cell type")+theme_classic()+scale_fill_manual(values=c("dodgerblue","gold","lightpink","orange","red","forestgreen"),labels=c("CTCF-only","dELS","DNase-H3K4me3","pELS","PLS","other"))+theme(legend.position="right", axis.text=element_text(size=12),axis.title=element_text(size=15), legend.text=element_text(size=12))
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Link_annot_byCT_filtered_encode.pdf", width=5, height=8)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Linked_peaks_olapk27_barPlot_filtered_XY.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Linked_peaks_olapk27_barPlot_filtered_split.pdf")
...
pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/",gene,"_linkPlot.pdf"), width=8, height=8)
p
dev.off()


kansl1<-data.frame(kansl1=as.vector(data[["RNA"]]["KANSL1",]), celltype=data$predicted.id, Status=data$Status)
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/KANSL1_boxplots.pdf", width=8,height=2)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/ALL_CT_BOXPLOT_prop_tt.pdf", width=10,height=5)
ggboxplot(df, y="Freq",x="Var2", fill="Status", alpha=0.8)+stat_pvalue_manual(stat.test, label="p")+xlab("")+scale_fill_manual(values=c("red","blue"))
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/All_subclusters_WNN.pdf", width=15, height=5)
...
dev.off()
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/All_subclusters_WNN_part2.pdf", width=10, height=10)
p4
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/WNN_diseasestat.pdf", width=6, height=6)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/WNN_moreStats.pdf", width=6, height=6)
p1
p2
dev.off()
...
df$frac<-frac
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Peak_olap_ADsnp.pdf")
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Distance_LinkedTSS_byScore.pdf",width=4,height=4)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Distance_LinkedTSS_byScore_boxplot.pdf",width=4,height=4)
...
## ## ## DON'T INCLUDE OTHER
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Score_Expression_GeneSize_by_LinkPerGene.pdf", width=10, height=6)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Peaks_per_gene_wDEGs_80Perm_StRes3.pdf", width=4, height=4)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Peaks_per_gene_Residuals.pdf")
...
## Gene body
```{r,eval=F}
gtf<-import("~/myers/quantseq/pool/STAR/genes.gtf")
gtf<-gtf[which(gtf$type=="gene"),]
...
c2_noProm<-c2_sub[which(c2_sub$annot !="Promoter"),]
```
...
447/911 DEGs are linked to a DAP in the same cell type. And vice versa 1215/8588 DAPs
976/1310 DAP-DEG links agree on log2FC direction
...
pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/",gene,"_linkPlot_w_DAP_",CT,".pdf"), width=8, height=5)
p
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/CellType-specific_linked_genes_GO.pdf", width=8, height=5)
ht2
dev.off()
...
## Mic links
```{r,eval=F}
part1<-import("/cluster/home/aanderson/scMultiomics_AD/reanalyze_Microglia2/outs/analysis/feature_linkage/feature_linkage.bedpe", format="bedpe")
...
mic.gr$dap<-mic.gr$peak %in% daps[which(daps$celltype=="Microglia"),]$gene
```

73 microglia links
35 found in the full link set
    AD common   Ctrl 
     4     27      4 
Links that overlapped full link set had higher scores
7 are to microglia AD/ctrl deg
5 are to microglia ad/ctrl dap
2 links are both deg and dap
-one is common and one ad-spec in full data
...
snps<-read.table("/cluster/projects/ADFTD/Colombia/2019.12.20_Escaper-Arrays/PLINK_060420_1223/2021.11.30-E280A-340/mac3_mac1_EPACTS.txt", header=F)
...
pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/",gene,"_linkPlot_w_snp.pdf"), width=8, height=8)
p
dev.off()
...
files=as.list(readLines("/cluster/home/aanderson/scMultiomics_AD/LinkPerm/random7/Linkages.txt"))
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/LinkPerm_propSpec_allCombinations_221118.pdf", width=5,height=4)
...
data$bin<-paste0(data$id, "-",data$predicted.id)
bin<-unique(data$bin)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Cor_psuedobulk_links_PDE10A.pdf")
...
```
                           ...
                           10X
-                  AD common   Ctrl     NA
        AD       4066  15585   1513  36953
pBulk   common   1525  15698   1071  10501
        Ctrl      403   4482   1746  20136
        NA      34837 169281  69698      0



We additionally evaluated the effect of cell-individual membership by calling links on counts that were pseudobulked by individual and cell type. A total of 16,421 links were identified, of which, 60% were found in the full link set. Additionally, 63% of shared links that we identified as AD-specific in our original analysis were also called as AD-specific in the pseudobulk analysis, showing that our approach has high concordance with methods that account for cell-individual membership.  However, we find that a pseudobulk link analysis is not well suited for our study given its small sample size, and that permutation analyses better address the question of an individual's contribution to link calling. Pseudobulking with a small sample size decreases the dynamic range across observations and leads to decreased sensitivity and fewer links called, but this approach could be more appropriate for studies with a larger sample size. Through our permutation analysis, we can assess the contribution of an AD individual to a link call. We identified a portion of our links that are only present in AD and not detectable across any individual controls (not detectable in any permutation where control individuals were included).
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/lit_search_validation_OR.pdf", width=6, height=4)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/lit_search_validation_eQTL_HiC.pdf", width=6, height=4)
...
pdf(paste0("~/myers/scAnalysis/plots/scMultiomics_AD/APP_linkPlot_olap_Luciferase.pdf"), width=8, height=8)
p
dev.off()
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/AD_linksPerGene_patch.pdf", height=5,width=7)
...
pdf("~/myers/scAnalysis/plots/scMultiomics_AD/Links_score_var_byMean.pdf")
