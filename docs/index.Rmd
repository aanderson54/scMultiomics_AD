...
pdf("~/myers/scAnalysis/plots/RINdrop/Triangle_correlations_Neuron_ExIn.pdf", width=5, height=10)
ht1
dev.off()
...
pdf(paste0("~/myers/scAnalysis/plots/RINdrop/MEF2C_ADCtrl_NEUN.pdf"), width=6, height=7)
p
dev.off()
...
pdf(paste0("~/myers/scAnalysis/plots/RINdrop/",gene,"_linkPlot_w_DAP_",CT,".pdf"), width=8, height=5)
p
dev.off()
...
pdf("~/myers/scAnalysis/plots/RINdrop/CellType-specific_linked_genes_GO.pdf", width=8, height=5)
ht2
dev.off()
...
pdf(paste0("~/myers/scAnalysis/plots/RINdrop/",gene,"_linkPlot_w_snp.pdf"), width=8, height=8)
p
dev.off()
...
pdf("~/myers/scAnalysis/plots/RINdrop/LinkPerm_propSpec_allCombinations_221118.pdf", width=5,height=4)
...
pdf("~/myers/scAnalysis/plots/RINdrop/Cor_psuedobulk_links_PDE10A.pdf")
